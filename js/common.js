...
winMsg.style = "position:absolute; z-index:10; top:40%; left:40%; font-size:70px; color:#ffde02; font-family:'Gaegu-Bold'; background-color:rgba(29, 118, 105, 0.8); padding:10px; border-radius:10px";
